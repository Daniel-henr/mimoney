...
const CostVisualizer = () => {
  return (
    <div className='transition-colors duration-500 py-2 px-4 mt-4 w-60 max-h-80 bg-essencial-50 border-custom-1 rounded-xl border-essencial-200 dark:bg-support-950 dark:border-support-600'>
