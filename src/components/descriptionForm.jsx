...
const DescriptionForm = () => {
  return (
    <div className='-mt-custom-17 px-5 py-6 bg-essencial-50 border-custom-1 border-essencial-200 rounded-xl max-w-custom-47 max-h-24 flex items-center dark:bg-support-950 dark:border-support-600'>
      {/* Seção de Descrição */}
      <div className='flex'>
        <div>
          ...
          <label className='border-essencial-200'>
            <input
              className='h-7 w-64 bg-support-100 border-support-200 border-custom-1 rounded-md placeholder:font-semibold pl-1 text-sm focus:outline-none text-primary-950 font-semibold dark:bg-primary-300 dark:border-primary-100 dark:text-primary-950 dark:placeholder:text-primary-800'
              type="text"
        ...
        <div className='ml-5'>
          ...
          <label className='border-essencial-200'>
            <input
              className='w-28 h-7 bg-support-100 border-support-200 border-custom-1 rounded-md placeholder:font-semibold pl-1 focus:outline-none font-semibold text-primary-950 dark:bg-primary-300 dark:border-primary-100 dark:text-primary-950 dark:placeholder:text-primary-800'
              type="number"
              placeholder='0,00'
            />
          </label>
